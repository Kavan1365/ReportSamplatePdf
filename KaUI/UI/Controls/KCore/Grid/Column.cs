    ...
    public class Column
    {
        ...
        public Column(PropertyInfo property)
        {
            ...
            if (property.PropertyType == typeof(bool) || property.PropertyType == typeof(bool?))
                Template = $"#if({ property.Name }){{#<span class=\"label label-success\">بله</span>#}}else{{#<span class=\"label label-warning\">خیر</span>#}}#";
        }
        ...
        private void SetClientType()
        {
            ...
            else if (Property.PropertyType == typeof(DateTime) || Property.PropertyType == typeof(DateTime?))
            {
                ...
                //ClientType = "date";
                IsDate = true;
                    Template = $"#if(" + Field + ") {# #=moment(" + Field + ").format(\"jYYYY/jMM/jDD\")# #}#";
                Editor=new JRaw("addMdDateTimePicker");
