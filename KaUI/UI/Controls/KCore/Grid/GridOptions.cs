...
namespace KaUI.UI.Controls.KCore.Grid
{
    public class GridOptions<TModel> : MvcControlAttributes
    {
        ...
        private void SetBaseCommands(Dictionary<string, string> attributes)
        {
            ...
            if (AllowEdit || !string.IsNullOrEmpty(AllowEditField))
            {
                ...
                template +=
                    $"#if({AllowEditField ?? "true"}){{#<em title=\"ویرایش\" onclick=\"kendeHandlers.gridDataSourceEdit(event)\" data-role=\"button\" class=\"btn btn-sm btn-success\" role=\"button\"><span class=\"k-icon k-i-edit\"></span></em>#}}#";
            }
        ...
        private object GetDataSource()
        {
            ...
            return new
            {
             ...
             //           dataType = "json",
             //           headers = new { Authorization = "Bearer " + _httpContextAccessor.HttpContext.User.Claims
