    ...
    public class GridOptions<TModel> : MvcControlAttributes
    {
        ...
        private void SetBaseCommands(Dictionary<string, string> attributes)
        {
            ...
            if (AllowDelete || !string.IsNullOrEmpty(AllowDeleteField))
            {
                ...
                template =
                    $"#if({AllowDeleteField ?? "true"}){{#<em title=\"حذف\" onclick=\"kendeHandlers.gridDataSourceDelete(event)\" data-role=\"button\" class=\"k-button k-button-icon\" role=\"button\"><span class=\"k-icon k-i-delete\"></span></em>#}}#";
            }
            ...
            if (AllowEdit || !string.IsNullOrEmpty(AllowEditField))
            {
                ...
                template +=
                    $"#if({AllowEditField ?? "true"}){{#<em title=\"ویرایش\" onclick=\"kendeHandlers.gridDataSourceEdit(event)\" data-role=\"button\" class=\"k-button k-button-icon\" role=\"button\"><span class=\"k-icon k-i-edit\"></span></em>#}}#";
            }
        ...
        private void SetToolbarButtons(Dictionary<string, string> attributes)
        {
            ...
            if (ShowAddButton)
            {
                ToolBarButtons.Add(new ToolBarButton { Name = "create" });
